...
<div class="border rounded p-2 m-2 mb-5">
    ...
    <button class="btn btn-outline-primary btn-sm py-0 mb-2" style="font-size: 0.8em" type="button" data-toggle="collapse" data-target="#collapse_target_{{$comment->id}}" aria-expanded="false" aria-controls="multiCollapseExample2">Reply
    </button>
    ...
    <div id="collapse_target_{{$comment->id}}" class="collapse">
        <form method="post" action="{{ route('reply.add') }}">
            ...
            <div class="col-lg-4">
                ...
                <input type="submit" class="btn btn-sm btn-outline-danger py-0 mx-sm-3" style="font-size: 0.8em;" value="Add Reply" />
            </div>
        </form>
    </div>
